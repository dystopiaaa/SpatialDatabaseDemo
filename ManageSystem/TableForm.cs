...
namespace InformationManageSystem
{
    public partial class TableForm : Form
    {
        ...
        public TableForm(string tableName, ref SqlConnection con)
        {
            InitializeComponent();
            this.Name = tableName;
            this.con = con;
        ...
        private void TableForm_Load(object sender, EventArgs e)
        {
            ...
            switch (this.Name)
            {
                case "员工基本信息表":                    
                    ...
                    break;
                case "员工婚姻情况表":
                    sql = "select * from employee_marry";
                    break;
                case "员工学历信息表":
                    sql = "select * from employee_education";
                    break;
                case "企业工作岗位表":
                    sql = "select job_id,job_dept_id,job_name from sys_job";
                    break;
                case "企业部门信息表":
