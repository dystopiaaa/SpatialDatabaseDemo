...
namespace PWMS_SYSTEM_V1._0.Perform
{
    public partial class F_HaveBack : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                //定义SQL语句实现到指定时间点的还原
                Str_dar = "backup database sy7 to disk='" + Str_dar + (System.DateTime.Now.ToShortDateString()).ToString() + MyMC.Time_Format(System.DateTime.Now.ToString()) + ".bak" + "'";
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //-------------------杀掉所有连接 sy7 数据库的进程--------------
                //定义sql语句，以及所使用的变量
                string strSQL = "select spid from master..sysprocesses where dbid=db_id( 'sy7') ";
                ...
                SqlCommand SQLcom = new SqlCommand("backup log sy7 to disk='" + textBox3.Text.Trim() + "' restore database sy7 from disk='" + textBox3.Text.Trim() + "'", Tem_con);
                //进行查询
